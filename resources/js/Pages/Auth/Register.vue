    ...
    <div class="flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8">
        ...
        <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
            <form class="space-y-6" @submit.prevent="submit">
                ...
                <div class="pt-4">
                    <button type="submit"
                        class="flex w-full justify-center rounded-md bg-elime-500 px-3 py-1.5 text-sm font-semibold leading-6 text-space-950 hover:bg-elime-600 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500"
